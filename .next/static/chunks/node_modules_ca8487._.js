(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_ca8487._.js", {
...
"[project]/node_modules/admin-lte/dist/js/adminlte.min.js [app-client] (ecmascript)": (function({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__, m: module, e: exports, t: require }) { !function() {
 ...
 */ !function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports, __turbopack_require__("[project]/node_modules/jquery/dist/jquery.js [app-client] (ecmascript)")) : "function" == typeof define && define.amd ? ((r)=>r !== undefined && __turbopack_export_value__(r))(t(exports, __turbopack_require__("[project]/node_modules/jquery/dist/jquery.js [app-client] (ecmascript)"))) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).adminlte = {}, e.jQuery);
}(this, function(e, t) {
    "use strict";
    function a(e) {
    ...
    var n = a(t), i = "CardRefresh", o = "lte.cardrefresh", s = n.default.fn[i], l = "card", r = '[data-card-widget="card-refresh"]', d = {
        source: "",
        sourceSelector: "",
        params: {},
        trigger: r,
    ...
    var T = "ControlSidebar", j = "lte.controlsidebar", S = n.default.fn[T], k = ".control-sidebar", Q = ".control-sidebar-content", H = '[data-widget="control-sidebar"]', z = ".main-header", F = ".main-footer", E = "control-sidebar-animate", D = "control-sidebar-open", L = "control-sidebar-slide-open", A = "layout-fixed", R = {
        ...
        return t.collapse = function() {
            ...
            if (e.hasClass(A)) {
                ...
                }, i = Math.abs(a.window + n.default(window).scrollTop() - a.scroll), o = n.default(window).scrollTop(), s = this._isNavbarFixed() && "fixed" === n.default(z).css("position"), l = this._isFooterFixed() && "fixed" === n.default(F).css("position"), r = n.default(this._config.target + ", " + this._config.target + " " + Q);
                if (0 === o && 0 === i) t.css({
                    bottom: a.footer,
                    top: a.header
    ...
    var ae = "Fullscreen", ne = "lte.fullscreen", ie = n.default.fn[ae], oe = '[data-widget="fullscreen"]', se = oe + " i", le = {
    ...
    var He = "lte.layout", ze = n.default.fn.Layout, Fe = ".main-header", Ee = ".main-sidebar", De = ".main-sidebar .sidebar", Le = ".main-footer", Ae = "sidebar-focused", Re = {
        scrollbarTheme: "os-theme-light",
        scrollbarAutoHide: "l",
        panelAutoHeight: !0,
    ...
    var qe = "PushMenu", Ne = "lte.pushmenu", Oe = "." + Ne, Pe = n.default.fn[qe], Ue = '[data-widget="pushmenu"]', Be = "body", $e = "sidebar-collapse", We = "sidebar-open", Ve = "sidebar-is-opening", Ge = "sidebar-closed", Je = {
    ...
    var Xe = "SidebarSearch", Ye = "lte.sidebar-search", Ze = n.default.fn[Xe], et = "sidebar-search-open", tt = "fa-search", at = "fa-times", nt = "sidebar-search-results", it = "list-group", ot = '[data-widget="sidebar-search"]', st = ot + " .form-control", lt = ot + " .btn", rt = lt + " i", dt = ".sidebar-search-results", ft = ".sidebar-search-results .list-group", ut = {
        arrowSign: "->",
        minLength: 3,
        maxResults: 7,
        highlightName: !0,
    ...
    var Lt = "Treeview", At = "lte.treeview", Rt = n.default.fn[Lt], Mt = ".nav-item", qt = ".nav-treeview", Nt = ".menu-open", Ot = '[data-widget="treeview"]', Pt = "menu-open", Ut = "menu-is-opening", Bt = {
        trigger: Ot + " .nav-link",
        animationSpeed: 300,
        accordion: !0,
        expandSidebar: !1,
...
//# sourceMappingURL=node_modules_ca8487._.js.map